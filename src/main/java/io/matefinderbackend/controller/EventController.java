...
public class EventController {
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    @DeleteMapping(path = "{eventId}/user/{userId}")
    void deleteUser(@PathVariable("eventId") long eventId, @PathVariable("userId") long userId) {
        eventFacade.removeUser(eventId, userId);
    }
